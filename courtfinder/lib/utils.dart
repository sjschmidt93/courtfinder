...
class Utils {
  ...
  static Widget getLocation(BuildContext context, String imageName,
      String locationName, String userToken) {
            ...
            onTap: () {
              Navigator.push(
                ...
                new MaterialPageRoute(
                    builder: (context) => locationName == 'New York'
                        ? new NewYorkScreen(userToken: userToken)
                        : new CourtScreen(locationName, 3, userToken)),
              );
            },
            child: new Container(
              height: 240.0,
